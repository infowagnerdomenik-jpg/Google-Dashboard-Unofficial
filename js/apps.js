...
function launchApp(url, intent) {
    ...
    if (isAndroid && intent) {
        // Wir setzen das Intent-Schema und lassen Android den Rest erledigen.
        window.location.href = intent;
        
        // Fallback: Wenn nach 1 Sekunde nichts passiert (App nicht installiert oder blockiert), Web-URL öffnen
        setTimeout(() => {
